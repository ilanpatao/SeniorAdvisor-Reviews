...
$('.go').click(function(){
	...
	if (url == ''){
		...
		// Call my API
		$.getJSON("https://cors-anywhere.herokuapp.com/https://www.reviewsmaker.com/api/public/senioradvisor?url=" + url, function (data){
			...
			$.each( data.reviews, function( key, value ) {
			  ...
			  $('.results').append('<b>Review Sentiment: </b>' + value.sentiment + "<br>");
